...
const generateUsers = (count: number) => {
  ...
  for (let i = 0; i < count; i++) {
    ...
    } while (usedUsernames.has(username) || usedUsernames.has(email));

    usedUsernames.add(username);
    usedUsernames.add(email);
...
export async function seedDatabase() {
  try {
    ...
    await db.insert(contents).values([
      { id: "content-a1", contentType: "video", title: "Fractales Africaines : Mathématiques Cachées", description: "L'architecture africaine antique repose sur des concepts mathématiques complexes (les fractales).", videoUrl: "https://www.youtube.com/watch?v=7n36qV4Lk94", textContent: null, imageUrl: null, roomId: "room-3", roomName: "Mathématiques Pures", category: "mathematics", difficulty: "intermediaire", tags: ["#Afrique", "#Fractales", "#Maths"], xpReward: 50, authorId: "lb-user-2", authorName: "Cheikh Anta Diop", authorAvatar: null, likes: 14500, comments: 2304, shares: 8900, createdAt: new Date(Date.now() - 3600000).toISOString() },
      { id: "content-a2", contentType: "video", title: "Smart City à Kigali : Le Rwanda de demain", description: "Découvrez comment le Rwanda utilise la technologie, l'IoT et les drones pour construire la ville intelligente du futur.", videoUrl: "https://www.youtube.com/watch?v=OnDpE8uSb7M", textContent: null, imageUrl: null, roomId: "room-4", roomName: "Espace & Aérospatial", category: "science", difficulty: "debutant", tags: ["#Rwanda", "#SmartCity", "#Innovation"], xpReward: 60, authorId: "af-user-1", authorName: "TechAfrica", authorAvatar: null, likes: 23000, comments: 4100, shares: 12050, createdAt: new Date(Date.now() - 7200000).toISOString() },
      { id: "content-a3", contentType: "video", title: "M-Pesa : Comment le Kenya a révolutionné la Fintech", description: "La révolution du paiement mobile née au Kenya et qui s'exporte partout dans le monde.", videoUrl: "https://www.youtube.com/watch?v=EzGmORspRT4", textContent: null, imageUrl: null, roomId: "room-2", roomName: "Tech Makers", category: "technology", difficulty: "debutant", tags: ["#Kenya", "#MPesa", "#Fintech", "#Tech"], xpReward: 40, authorId: "af-user-15", authorName: "Tech Connect", authorAvatar: null, likes: 350000, comments: 12054, shares: 45000, createdAt: new Date(Date.now() - 14400000).toISOString() },
      { id: "content-a4", contentType: "video", title: "L'Intelligence Artificielle en Afrique de l'Ouest", description: "Comment les universités sénégalaises et béninoises créent leurs propres modèles d'IA pour les langues locales (Wolof, Fon).", videoUrl: "https://www.youtube.com/watch?v=xP_9MZutg9Q", textContent: null, imageUrl: null, roomId: "room-1", roomName: "Innovations d'Afrique", category: "technology", difficulty: "avance", tags: ["#IA", "#Bénin", "#Sénégal", "#Langues"], xpReward: 70, authorId: "af-user-42", authorName: "Africa Sciences", authorAvatar: null, likes: 18400, comments: 1540, shares: 6200, createdAt: new Date(Date.now() - 28800000).toISOString() },
      { id: "content-a5", contentType: "video", title: "Innovation Agricole au Ghana", description: "L'utilisation de la robotique et de l'ingénierie pour décupler les rendements agricoles au Ghana.", videoUrl: "https://www.youtube.com/watch?v=YO1knvQ6eUo", textContent: null, imageUrl: null, roomId: "room-1", roomName: "Innovations d'Afrique", category: "technology", difficulty: "debutant", tags: ["#Ghana", "#AgriTech", "#Robotique"], xpReward: 45, authorId: "af-user-88", authorName: "Tech 235", authorAvatar: null, likes: 9600, comments: 853, shares: 2100, createdAt: new Date(Date.now() - 43200000).toISOString() },

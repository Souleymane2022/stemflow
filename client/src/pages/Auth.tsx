...
export default function Auth() {
  ...
  useEffect(() => {
    ...
    if (error === "oauth_failed") {
      toast({ title: "Erreur", description: "La connexion via Google/Replit a échoué. Veuillez réessayer.", variant: "destructive" });
      window.history.replaceState({}, "", "/auth");
    }
  }, []);
          ...
          {(step === "login" || step === "register") && (
            <div className="flex items-center gap-1 mb-6">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors ${step === "login"
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors ${step === "register"
                    ? "bg-muted text-foreground"
                    : "text-muted-foreground"
                  }`}
          ...
          {(step === "login" || step === "register") && (
            <>
              ...
              <a
                ...
                className="w-full flex items-center justify-center gap-2 rounded-md border border-muted px-4 py-2.5 text-sm font-medium transition-colors hover-elevate"
